...
const Properties = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-primary/5">
      ...
      {locationFilter && (
        <>
          <div className="fixed left-0 right-0 top-[40px] md:top-[44px] lg:top-[48px] z-40 bg-gradient-to-r from-primary to-primary/80 text-primary-foreground py-1 md:py-2">
            <div className="container mx-auto px-3 md:px-4">
              <div className="flex items-center justify-between gap-1 md:gap-2">
                ...
                <div className="text-center flex-1">
                  <h1 className="text-[10px] md:text-sm font-semibold leading-tight">
          ...
          <div aria-hidden className="h-7 md:h-10" />
        </>
      )}
