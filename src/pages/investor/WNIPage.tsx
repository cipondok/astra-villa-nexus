  ...
  const copy = {
    en: {
      ...
      benefits: [
        ...
        { icon: CreditCard, title: "Flexible Payments", desc: "Payment plans aligned with overseas income schedules" },
    ...
    id: {
      ...
      benefits: [
        ...
        { icon: CreditCard, title: "Pembayaran Fleksibel", desc: "Rencana pembayaran sesuai jadwal penghasilan di luar negeri" },
      ...
      <section className="px-3 py-6 sm:px-4 sm:py-8 md:py-12">
        <div className="max-w-6xl mx-auto">
          ...
          <motion.p
            ...
            viewport={{ once: true }}
            className="text-center text-sm sm:text-base md:text-lg font-medium text-primary mt-8 sm:mt-10"
          >
            ✨ {t.tagline}
          </motion.p>
        </div>
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              <Button
                ...
                className="gap-2 w-full sm:w-auto bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700"
              >
