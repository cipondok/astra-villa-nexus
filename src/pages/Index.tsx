...
const Index = () => {
  ...
  const content = (
    ...
    >
      ...
      <div className="relative z-10 min-h-stable md:min-h-screen bg-white/90 dark:bg-black/90 backdrop-blur-sm safe-area-mobile pt-12 md:pt-14 lg:pt-16 px-0 md:px-2">
