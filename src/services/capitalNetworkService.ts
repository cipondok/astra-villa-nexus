...
export function computeRegionalCapitalSignals(
  ...
  const regions: RegionalCapitalSignal[] = [
    { region: 'Bali', country: 'Indonesia', liquidityDensity: Math.round(65 * platformScale + 15), capitalReadiness: 'active', investorDensityScore: Math.round(70 * platformScale + 10), crossBorderFlowIndex: Math.round(55 * platformScale + 15), institutionalInterest: Math.round(30 * platformScale + 5), opportunityClusters: Math.max(Math.round(totalProperties * 0.4), 1), priority: 'primary' },
    { region: 'Jakarta', country: 'Indonesia', liquidityDensity: Math.round(50 * platformScale + 10), capitalReadiness: 'warming', investorDensityScore: Math.round(60 * platformScale + 5), crossBorderFlowIndex: Math.round(30 * platformScale + 5), institutionalInterest: Math.round(40 * platformScale + 5), opportunityClusters: Math.max(Math.round(totalProperties * 0.2), 1), priority: 'primary' },
    { region: 'Singapore', country: 'Singapore', liquidityDensity: Math.round(35 * platformScale + 5), capitalReadiness: 'warming', investorDensityScore: Math.round(80 * platformScale), crossBorderFlowIndex: Math.round(70 * platformScale), institutionalInterest: Math.round(65 * platformScale), opportunityClusters: Math.max(Math.round(totalProperties * 0.05), 0), priority: 'secondary' },
    { region: 'Dubai', country: 'UAE', liquidityDensity: Math.round(20 * platformScale + 3), capitalReadiness: 'dormant', investorDensityScore: Math.round(75 * platformScale), crossBorderFlowIndex: Math.round(60 * platformScale), institutionalInterest: Math.round(50 * platformScale), opportunityClusters: 0, priority: 'emerging' },
    { region: 'Bangkok', country: 'Thailand', liquidityDensity: Math.round(25 * platformScale + 5), capitalReadiness: 'dormant', investorDensityScore: Math.round(40 * platformScale + 5), crossBorderFlowIndex: Math.round(35 * platformScale), institutionalInterest: Math.round(20 * platformScale), opportunityClusters: 0, priority: 'emerging' },
  ].map(r => ({
    ...r,
