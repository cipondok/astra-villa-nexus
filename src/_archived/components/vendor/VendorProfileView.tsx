        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="space-y-2">
              ...
              <div className="space-y-1 text-sm">
                <p><span className="text-muted-foreground">Type:</span> {profile.business_type || 'Not specified'}</p>
                <p><span className="text-muted-foreground">Nature:</span> {businessNature?.name || 'Not selected'}</p>
            ...
            <div className="space-y-2">
              ...
              <div className="space-y-1 text-sm">
                ...
                <p><span className="text-muted-foreground">Reviews:</span> {profile.total_reviews || 0}</p>
                <p><span className="text-muted-foreground">Member since:</span> {formatDate(profile.created_at)}</p>
              </div>
            </div>
          </div>
          ...
          {profile.business_description && (
            <div className="mt-4 pt-4 border-t">
              ...
              <p className="text-sm text-muted-foreground">{profile.business_description}</p>
            </div>
          )}
        </CardContent>
      </Card>
