...
const LightingPanel = ({ timeOfDay, onTimeChange }: LightingPanelProps) => {
  ...
  return (
    <div className="absolute top-1/2 -translate-y-1/2 right-4 z-10 bg-background/50 backdrop-blur-sm rounded-lg p-4 w-64 space-y-4 animate-slide-in-right">
      <h3 className="text-foreground font-semibold">Lighting Control</h3>
      <div>
        <Label
          htmlFor="time-slider"
