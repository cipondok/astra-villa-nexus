...
const AdvancedFilters = ({ language, onFiltersChange, onSearch, open, onOpenChange }: AdvancedFiltersProps) => {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent 
        className="max-w-[95vw] sm:max-w-4xl lg:max-w-6xl xl:max-w-7xl max-h-[70vh] sm:max-h-[75vh] p-0 flex flex-col bg-background/95 backdrop-blur-2xl rounded-2xl border border-border/40 shadow-2xl"
