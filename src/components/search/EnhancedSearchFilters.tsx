...
const EnhancedSearchFilters = ({ language, onSearch }: EnhancedSearchFiltersProps) => {
  ...
  const currentText = {
    search: t('enhancedSearch.search'),
    state: t('enhancedSearch.state'),
    city: t('enhancedSearch.city'),
    area: t('enhancedSearch.area'),
    propertyType: t('enhancedSearch.propertyType'),
    listingType: t('enhancedSearch.listingType'),
    price: t('enhancedSearch.price'),
    bedrooms: t('enhancedSearch.bedrooms'),
    bathrooms: t('enhancedSearch.bathrooms'),
    amenities: t('enhancedSearch.amenities'),
    searchBtn: t('enhancedSearch.searchBtn'),
    trending: t('enhancedSearch.trending'),
    forSale: t('enhancedSearch.forSale'),
    forRent: t('enhancedSearch.forRent'),
    forLease: t('enhancedSearch.forLease'),
    allTypes: t('enhancedSearch.allTypes'),
    anyPrice: t('enhancedSearch.anyPrice'),
    anyBedroom: t('enhancedSearch.anyBedroom'),
    anyBathroom: t('enhancedSearch.anyBathroom'),
    filters: t('enhancedSearch.filters'),
    myLocation: t('enhancedSearch.myLocation'),
    facilities: t('enhancedSearch.facilities'),
    buyFacilities: t('enhancedSearch.buyFacilities'),
    rentFacilities: t('enhancedSearch.rentFacilities'),
  };
        ...
        <div className="flex flex-col lg:flex-row gap-2 md:gap-3 mb-3 md:mb-4">
          ...
          <div className="flex gap-1.5 md:gap-2">
            ...
            <Popover open={showFacilities} onOpenChange={setShowFacilities}>
              ...
              <PopoverContent className="w-72 sm:w-80 p-4 bg-background border border-border/50 shadow-lg rounded-2xl z-50" align="end" sideOffset={8}>
                <div className="space-y-3">
                  {/* Buy Facilities */}
                  <div>
                    <label className="text-xs font-semibold text-foreground mb-1.5 block">{currentText.buyFacilities}</label>
                  ...
                  {/* Rent Facilities */}
                  <div>
                    <label className="text-xs font-semibold text-foreground mb-1.5 block">{currentText.rentFacilities}</label>
                    <div className="flex flex-wrap gap-1.5">
              ...
              <PopoverContent className="w-72 sm:w-80 p-4 bg-background border border-border/50 shadow-lg rounded-2xl z-50" align="end" sideOffset={8}>
                <div className="space-y-3">
                  <div className="grid grid-cols-2 gap-2">
                    <div>
                      <label className="text-xs font-semibold text-foreground mb-1 block">{currentText.listingType}</label>
                    ...
                    <div>
                      <label className="text-xs font-semibold text-foreground mb-1 block">{currentText.price}</label>
                    ...
                    <div>
                      <label className="text-xs font-semibold text-foreground mb-1 block">{currentText.bedrooms}</label>
                    ...
                    <div>
                      <label className="text-xs font-semibold text-foreground mb-1 block">{currentText.bathrooms}</label>
                  ...
                  {/* Amenities */}
                  <div>
                    <label className="text-xs font-semibold text-foreground mb-1.5 block">{currentText.amenities}</label>
                    <div className="flex flex-wrap gap-1.5">
