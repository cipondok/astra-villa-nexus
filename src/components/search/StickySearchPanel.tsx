...
const StickySearchPanel = ({
  ...
  const currentText = {
    search: t('stickySearch.search'),
    filters: t('stickySearch.filters'),
    searchBtn: t('stickySearch.searchBtn'),
    saveSearch: t('stickySearch.saveSearch'),
    savedSearches: t('stickySearch.savedSearches'),
    recentSearches: t('stickySearch.recentSearches'),
    noRecent: t('stickySearch.noRecent'),
    noSaved: t('stickySearch.noSaved'),
    searchName: t('stickySearch.searchName'),
    save: t('stickySearch.save'),
    cancel: t('stickySearch.cancel'),
    keyboardHint: t('stickySearch.keyboardHint'),
    analytics: t('stickySearch.analytics'),
    export: t('stickySearch.export'),
    voiceSearch: t('stickySearch.voiceSearch'),
    listening: t('stickySearch.listening'),
    aiSuggest: t('stickySearch.aiSuggest'),
    compare: t('stickySearch.compare'),
    aiSuggestions: t('stickySearch.aiSuggestions'),
    compareSearches: t('stickySearch.compareSearches'),
    selectFirst: t('stickySearch.selectFirst'),
    selectSecond: t('stickySearch.selectSecond'),
    differences: t('stickySearch.differences'),
    similarities: t('stickySearch.similarities'),
    share: t('stickySearch.share'),
    notifications: t('stickySearch.notifications'),
    notifyMe: t('stickySearch.notifyMe'),
    shareLink: t('stickySearch.shareLink'),
    copyLink: t('stickySearch.copyLink'),
    qrCode: t('stickySearch.qrCode'),
    expiresIn: t('stickySearch.expiresIn'),
    notificationsOff: t('stickySearch.notificationsOff'),
    notificationsOn: t('stickySearch.notificationsOn'),
    newMatches: t('stickySearch.newMatches'),
    priceDrops: t('stickySearch.priceDrops'),
    markAllRead: t('stickySearch.markAllRead'),
    clearAll: t('stickySearch.clearAll'),
    filterAll: t('stickySearch.filterAll'),
    filterPriceDrops: t('stickySearch.filterPriceDrops'),
    filterNewMatches: t('stickySearch.filterNewMatches'),
    notificationHistory: t('stickySearch.notificationHistory'),
    shareAnalytics: t('stickySearch.shareAnalytics'),
    views: t('stickySearch.views'),
    clicks: t('stickySearch.clicks'),
    clickRate: t('stickySearch.clickRate'),
    topReferrers: t('stickySearch.topReferrers'),
    viewsOverTime: t('stickySearch.viewsOverTime'),
    collaborators: t('stickySearch.collaborators'),
    liveEditing: t('stickySearch.liveEditing'),
  };
