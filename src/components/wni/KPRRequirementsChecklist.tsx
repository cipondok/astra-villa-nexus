    ...
    <Card className={cn("border border-primary/10 bg-transparent dark:bg-white/5 backdrop-blur-xl shadow-sm", className)}>
      ...
      <CardContent className="space-y-4">
          ...
          {(['identity', 'employment', 'financial', 'property'] as const).map((category, idx) => {
            ...
            return (
              ...
              >
                <AccordionItem 
                  value={category} 
                  className="border border-border/50 rounded-xl px-4 bg-background/50"
                >
                  <AccordionTrigger className="hover:no-underline py-3">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="text-left">
                        <p className="text-sm font-semibold">{t.categories[category]}</p>
        ...
        <div className="flex items-start gap-2 p-3 bg-blue-500/10 border border-blue-500/20 rounded-xl">
          ...
          <div>
            <p className="text-xs font-medium text-blue-700 dark:text-blue-400">{t.importantNote}</p>
            <p className="text-[10px] text-muted-foreground">{t.noteText}</p>
          </div>
        </div>
