...
const AstraSearchPanel = ({
  ...
  const currentText = {
    searchPlaceholder: t('astraSearch.searchPlaceholder'),
    search: t('astraSearch.search'),
    all: t('astraSearch.all'),
    forSale: t('astraSearch.forSale'),
    forRent: t('astraSearch.forRent'),
    newProject: t('astraSearch.newProject'),
    location: t('astraSearch.location'),
    propertyType: t('astraSearch.propertyType'),
    listingType: t('astraSearch.listingType'),
    priceRange: t('astraSearch.priceRange'),
    bedrooms: t('astraSearch.bedrooms'),
    bathrooms: t('astraSearch.bathrooms'),
    area: t('astraSearch.area'),
    features: t('astraSearch.features'),
    facilities: t('astraSearch.facilities'),
    yearBuilt: t('astraSearch.yearBuilt'),
    condition: t('astraSearch.condition'),
    furnishing: t('astraSearch.furnishing'),
    sortBy: t('astraSearch.sortBy'),
    any: t('astraSearch.any'),
    villa: t('astraSearch.villa'),
    apartment: t('astraSearch.apartment'),
    house: t('astraSearch.house'),
    townhouse: t('astraSearch.townhouse'),
    land: t('astraSearch.land'),
    condo: t('astraSearch.condo'),
    office: t('astraSearch.office'),
    resultsFound: t('astraSearch.resultsFound'),
    filters: t('astraSearch.filters'),
    clearFilters: t('astraSearch.clearFilters'),
    advancedFilters: t('astraSearch.advancedFilters'),
    selectedFilters: t('astraSearch.selectedFilters'),
    newest: t('astraSearch.newest'),
    priceLow: t('astraSearch.priceLow'),
    priceHigh: t('astraSearch.priceHigh'),
    areaLarge: t('astraSearch.areaLarge'),
    parking: t('astraSearch.parking'),
    pool: t('astraSearch.pool'),
    gym: t('astraSearch.gym'),
    garden: t('astraSearch.garden'),
    security: t('astraSearch.security'),
    furnished: t('astraSearch.furnished'),
    checkIn: t('astraSearch.checkIn'),
    checkOut: t('astraSearch.checkOut'),
    rentalDuration: t('astraSearch.rentalDuration'),
    tripPurpose: t('astraSearch.tripPurpose'),
    selectDate: t('astraSearch.selectDate'),
    days: t('astraSearch.days'),
    solo: t('astraSearch.solo'),
    business: t('astraSearch.business'),
    family: t('astraSearch.family'),
    group: t('astraSearch.group'),
    couple: t('astraSearch.couple'),
    other: t('astraSearch.other'),
    month: t('astraSearch.month'),
    months: t('astraSearch.months'),
    rentalDetails: t('astraSearch.rentalDetails'),
    wifi: t('astraSearch.wifi'),
    ac: t('astraSearch.ac'),
    laundry: t('astraSearch.laundry'),
    kitchen: t('astraSearch.kitchen'),
    petsAllowed: t('astraSearch.petsAllowed'),
    elevator: t('astraSearch.elevator'),
    cctv: t('astraSearch.cctv'),
    balcony: t('astraSearch.balcony'),
    storage: t('astraSearch.storage'),
    maidRoom: t('astraSearch.maidRoom'),
    studyRoom: t('astraSearch.studyRoom'),
    walkInCloset: t('astraSearch.walkInCloset'),
    intercom: t('astraSearch.intercom'),
    generator: t('astraSearch.generator'),
    waterHeater: t('astraSearch.waterHeater'),
    housekeeping: t('astraSearch.housekeeping'),
    concierge: t('astraSearch.concierge'),
    coworking: t('astraSearch.coworking'),
    playground: t('astraSearch.playground'),
    bbqArea: t('astraSearch.bbqArea'),
    nearMe: t('astraSearch.nearMe'),
    searchNearby: t('astraSearch.searchNearby'),
    radius: t('astraSearch.radius'),
    gettingLocation: t('astraSearch.gettingLocation'),
    locationError: t('astraSearch.locationError'),
    within: t('astraSearch.within'),
    selectProvince: t('astraSearch.selectProvince'),
    selectCity: t('astraSearch.selectCity'),
    selectArea: t('astraSearch.selectArea'),
