      ...
      <div className="apple-glass border-2 border-border/30 shadow-lg rounded-2xl">
        <div className="p-4 sm:p-6">
          ...
          {activeFiltersCount > 0 && (
            <div className="flex items-center justify-between mb-4 p-3 bg-primary/5 rounded-xl border border-primary/20 shadow-sm">
              <div className="flex items-center gap-2">
                <div className="flex items-center gap-2">
                  ...
                  <span className="bg-primary/10 text-primary border-primary/20 font-medium px-2 py-1 text-sm rounded-full border">
                    {activeFiltersCount}
                  </span>
                </div>
              </div>
              <Button
                ...
                className="text-destructive hover:text-destructive hover:bg-destructive/10 border-destructive/30 hover:border-destructive/50 font-medium transition-all duration-200 text-sm"
              >
            ...
            <div className="w-full">
              <div className="relative group">
                ...
                <Input
                  ...
                  className="apple-input pl-10 h-12 text-sm font-medium placeholder:text-muted-foreground"
                  value={searchQuery}
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
              ...
              <div className="relative">
                <Select value={selectedState} onValueChange={setSelectedState}>
                  <SelectTrigger className="apple-input h-12 font-medium">
                    <div className="flex items-center gap-2">
                      <MapPin className="h-4 w-4 text-muted-foreground flex-shrink-0" />
                      <SelectValue placeholder={currentText.state} className="text-sm truncate" />
                    </div>
                  </SelectTrigger>
                ...
                <Select value={propertyType} onValueChange={setPropertyType}>
                  <SelectTrigger className="apple-input h-12 font-medium">
                    <div className="flex items-center gap-2">
                      ...
                      <SelectValue placeholder={currentText.type} className="text-sm truncate" />
                    </div>
                  </SelectTrigger>
                  <SelectContent className="apple-dropdown">
                    <SelectItem value="all" className="font-semibold text-primary hover:bg-primary/10">
                ...
                <Select value={bedrooms} onValueChange={setBedrooms}>
                  <SelectTrigger className="apple-input h-12 font-medium">
                    <div className="flex items-center gap-2">
                      ...
                      <SelectValue placeholder={currentText.bedrooms} className="text-sm truncate" />
                    </div>
                  </SelectTrigger>
                  <SelectContent className="apple-dropdown">
                ...
                <Select value={bathrooms} onValueChange={setBathrooms}>
                  <SelectTrigger className="apple-input h-12 font-medium">
                    <div className="flex items-center gap-2">
                      ...
                      <SelectValue placeholder={currentText.bathrooms} className="text-sm truncate" />
                    </div>
                  </SelectTrigger>
                  <SelectContent className="apple-dropdown">
                    <SelectItem value="any" className="font-semibold text-primary hover:bg-primary/10">
          ...
          <div className="space-y-3">
            ...
            <div className="flex flex-wrap gap-2">
              {trendingSearches.map((term, index) => (
                <span
                  key={index} 
                  className="cursor-pointer hover:bg-primary/10 hover:text-primary hover:border-primary/20 transition-all duration-200 px-3 py-1.5 text-sm font-medium rounded-full shadow-sm hover:shadow-md bg-secondary/80 text-secondary-foreground border border-border"
