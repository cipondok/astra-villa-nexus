    ...
    >
      ...
      <div className="absolute inset-0 flex items-center justify-between px-2">
        <Sun className={cn(
          ...
          isDayMode ? "text-yellow-200 opacity-100" : "text-yellow-200/30 opacity-50"
        )} />
        <Moon className={cn(
          "h-4 w-4 transition-opacity duration-300",
      ...
      >
        ...
        {isDayMode ? (
          ...
          // Moon craters
          <>
            <div className="absolute top-1 right-1 w-1.5 h-1.5 rounded-full bg-gray-400/50" />
            <div className="absolute bottom-2 left-1.5 w-1 h-1 rounded-full bg-gray-400/50" />
          </>
        )}
      </motion.div>
