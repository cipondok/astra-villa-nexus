...
const Navigation = () => {
  ...
  return (
    <>
      <nav className="fixed top-0 left-0 right-0 w-full z-[10000] header-ios bg-[hsl(220,30%,85%)] dark:bg-[hsl(220,50%,6%)] border-b border-border/30 shadow-sm h-10 md:h-11 lg:h-12 transition-all duration-700">
