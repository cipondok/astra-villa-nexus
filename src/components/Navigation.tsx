...
const Navigation = () => {
  ...
  return (
    <>
      <nav className="fixed top-0 left-0 right-0 w-full z-[10000] header-ios bg-background border-b border-border/30 shadow-sm h-10 md:h-11 lg:h-12 transition-all duration-700">
