          ...
          <div className="grid sm:grid-cols-2 gap-3 sm:gap-4 mb-4 sm:mb-5">
            ...
            >
              ...
              <div className="mt-2.5 flex items-center justify-between">
                <span onClick={() => navigate("/investment")} className="text-[11px] font-bold text-[#006bb3] dark:text-blue-300 cursor-pointer hover:underline">🌍 Foreign Investment Program</span>
