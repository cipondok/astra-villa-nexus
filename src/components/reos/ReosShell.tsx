              ...
              <div className="relative" ref={profileRef}>
                ...
                {profileOpen && (
                  <div role="menu" className="absolute right-0 mt-2 w-48 reos-card p-1 z-50 shadow-2xl">
                    <button type="button" onClick={() => { setProfileOpen(false); navigate("/"); }} className="w-full text-left px-3 py-2 rounded-md text-[12.5px] hover:bg-[var(--surface-2)] inline-flex items-center gap-2 text-[var(--text)]"><LayoutDashboard className="h-3.5 w-3.5" /> Dashboard</button>
