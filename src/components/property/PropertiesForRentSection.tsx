...
const PropertiesForRentSection = ({ language, onPropertyClick }: PropertiesForRentSectionProps) => {
  ...
  return (
    <section className="rounded-xl px-2 py-4 sm:p-4">
      <div className="mb-4 flex items-center justify-between">
        <div className="flex items-center gap-2.5">
          <div className="h-8 w-8 rounded-xl bg-gradient-to-br from-chart-4 to-primary flex items-center justify-center shadow-md shadow-chart-4/20">
            <Key className="h-4 w-4 text-white" />
          </div>
          <div>
            <h2 className="text-base sm:text-lg font-bold text-foreground tracking-tight">Properti Disewa</h2>
            <p className="text-[10px] sm:text-xs text-muted-foreground">
              {rentProperties.length} properti tersedia
            </p>
          </div>
        </div>
        <button
            ...
            >
              ...
              <div className="relative aspect-[4/3] overflow-hidden bg-muted">
                ...
                <div className="absolute top-1.5 left-1.5 right-1.5 flex items-center justify-between">
                  <span className="flex items-center gap-1 px-2 py-0.5 rounded-md text-[10px] font-bold bg-gradient-to-r from-sky-500 to-blue-600 text-white shadow-md backdrop-blur-sm">
                ...
                {/* Image count badge */}
                {imageCount > 1 && (
                  <div className="absolute bottom-1.5 right-1.5 flex items-center gap-0.5 bg-black/40 backdrop-blur-md text-white text-[10px] px-1.5 py-0.5 rounded-full">
              ...
              <div className="p-2 sm:p-2.5 space-y-1.5 relative">
                ...
                <div className="flex items-baseline gap-1 bg-primary/5 border border-primary/15 rounded-lg px-2 py-1.5 sm:px-2.5 sm:py-2 flex-wrap">
                  ...
                  <span className="text-[10px] text-muted-foreground font-bold ml-auto">/bln</span>
                </div>
