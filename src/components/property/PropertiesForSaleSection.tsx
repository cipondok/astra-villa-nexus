      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-1.5 sm:gap-2 md:gap-3">
        {saleProperties.slice(0, 6).map((property) => (
          <div
            ...
            className="group cursor-pointer relative rounded-lg sm:rounded-xl overflow-hidden h-28 sm:h-32 md:h-44 hover:scale-[1.02] transition-all duration-200 ring-1 ring-green-200/50 dark:ring-green-800/30"
          >
            ...
            <div className="absolute top-1 left-1 right-1 sm:top-1.5 sm:left-1.5 sm:right-1.5 md:top-2 md:left-2 md:right-2 flex items-start justify-between">
              {/* Sale Badge */}
              <span className="text-[7px] sm:text-[8px] md:text-xs font-bold px-1.5 py-0.5 sm:px-2 sm:py-1 rounded-full bg-gradient-to-r from-green-500 to-emerald-600 text-white shadow-lg">
                Jual
              </span>
              {/* Property Type */}
            ...
            <div className="absolute top-1/2 left-1 sm:left-1.5 md:left-2 -translate-y-1/2">
              <span className="text-[8px] sm:text-[10px] md:text-sm font-bold px-1.5 py-0.5 sm:px-2 sm:py-1 rounded-md bg-gradient-to-r from-green-600 to-emerald-700 text-white shadow-xl">
