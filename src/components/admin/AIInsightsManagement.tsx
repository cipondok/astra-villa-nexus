...
const AIInsightsManagement = () => {
  ...
  const getSuggestionBadge = (type: string) => {
    switch (type) {
      case 'service_improvement':
        return <Badge className="bg-chart-2/10 text-chart-2 border-chart-2/20">Service Improvement</Badge>;
      case 'pricing_optimization':
        return <Badge className="bg-chart-1/10 text-chart-1 border-chart-1/20">Pricing Strategy</Badge>;
      case 'category_expansion':
        return <Badge className="bg-primary/10 text-primary border-primary/20">Category Expansion</Badge>;
      default:
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      case 'implemented':
        return <Badge className="bg-chart-1/10 text-chart-1 border-chart-1/20">Implemented</Badge>;
      case 'viewed':
        return <Badge className="bg-chart-3/10 text-chart-3 border-chart-3/20">Viewed</Badge>;
      case 'dismissed':
        return <Badge className="bg-destructive/10 text-destructive border-destructive/20">Dismissed</Badge>;
      default:
  ...
  const getUserTypeBadge = (userType: string) => {
    switch (userType) {
      case 'vendor':
        return <Badge className="bg-chart-2/10 text-chart-2 border-chart-2/20">Vendor</Badge>;
      case 'customer':
        return <Badge className="bg-chart-1/10 text-chart-1 border-chart-1/20">Customer</Badge>;
      default:
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-muted-foreground">Total AI Chats</p>
                <p className="text-2xl font-bold text-chart-2">{totalChats}</p>
              </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-chart-1">{uniqueUsers}</p>
              </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-primary">{totalSuggestions}</p>
              </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-chart-4">{implementedSuggestions}</p>
              </div>
