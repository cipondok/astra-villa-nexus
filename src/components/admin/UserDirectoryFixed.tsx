          ...
          <div className="space-y-4">
            {selectedUser && (
              <div>
                ...
                {getVendorProfile(selectedUser)?.business_name && (
                  <p className="text-sm font-medium">{getVendorProfile(selectedUser)?.business_name}</p>
                )}
              </div>
            )}
...
export default UserDirectoryFixed;