...
const PartnershipExpansionDashboard = lazy(() => import('./PartnershipExpansionDashboard'));
const BrandAuthorityDashboard = lazy(() => import('./BrandAuthorityDashboard'));
const MonetizationStrategyDashboard = lazy(() => import('./MonetizationStrategyDashboard'));
const InvestorPitchDashboard = lazy(() => import('./InvestorPitchDashboard'));
const InvestorCommunityDashboard = lazy(() => import('./InvestorCommunityDashboard'));
...
const DeveloperPartnershipFramework = lazy(() => import('./DeveloperPartnershipFramework'));
...
const DynamicAdminContent = ({ activeSection, onSectionChange }: DynamicAdminContentProps) => {
  ...
  const renderContent = () => {
    switch (activeSection) {
      ...
      case "partnership-expansion":
        return (
          <Suspense fallback={<div className="flex items-center justify-center py-20"><Loader2 className="h-6 w-6 animate-spin text-muted-foreground" /></div>}>
            <PartnershipExpansionDashboard />
          </Suspense>
        );
      case "brand-authority":
        return (
          <Suspense fallback={<div className="flex items-center justify-center py-20"><Loader2 className="h-6 w-6 animate-spin text-muted-foreground" /></div>}>
            <BrandAuthorityDashboard />
          </Suspense>
        );
      case "monetization-strategy":
        return (
          <Suspense fallback={<div className="flex items-center justify-center py-20"><Loader2 className="h-6 w-6 animate-spin text-muted-foreground" /></div>}>
            <MonetizationStrategyDashboard />
          </Suspense>
        );
      case "investor-pitch":
        return (
          <Suspense fallback={<div className="flex items-center justify-center py-20"><Loader2 className="h-6 w-6 animate-spin text-muted-foreground" /></div>}>
            <InvestorPitchDashboard />
          </Suspense>
        );
      case "investor-community":
        return (
          <Suspense fallback={<div className="flex items-center justify-center py-20"><Loader2 className="h-6 w-6 animate-spin text-muted-foreground" /></div>}>
            <InvestorCommunityDashboard />
          </Suspense>
        );
      case "geo-expansion":
        return (
          <Suspense fallback={<div className="flex items-center justify-center py-20"><Loader2 className="h-6 w-6 animate-spin text-muted-foreground" /></div>}>
            <GeoExpansionDashboard />
          </Suspense>
        );
      case "founder-branding":
        return (
          <Suspense fallback={<div className="flex items-center justify-center py-20"><Loader2 className="h-6 w-6 animate-spin text-muted-foreground" /></div>}>
      ...
      case "digital-growth-role":
        return (
          <Suspense fallback={<div className="flex items-center justify-center py-20"><Loader2 className="h-6 w-6 animate-spin text-muted-foreground" /></div>}>
            <DigitalGrowthRole />
          </Suspense>
        );
      case "property-supply-manager-role":
        return (
          <Suspense fallback={<div className="flex items-center justify-center py-20"><Loader2 className="h-6 w-6 animate-spin text-muted-foreground" /></div>}>
            <PropertySupplyManagerRole />
          </Suspense>
        );
      case "customer-success-role":
        return (
          <Suspense fallback={<div className="flex items-center justify-center py-20"><Loader2 className="h-6 w-6 animate-spin text-muted-foreground" /></div>}>
            <CustomerSuccessRole />
          </Suspense>
