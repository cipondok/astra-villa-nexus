...
import { Facebook, Twitter, Instagram, Youtube, MessageCircle, Save, Globe, Music2 } from 'lucide-react';
    ...
    <Card>
      ...
      <CardContent className="space-y-5">
        ...
        <div className="pt-2 border-t border-border/40">
          <Button onClick={saveSettings} disabled={isLoading || isSaving} className="gap-2">
