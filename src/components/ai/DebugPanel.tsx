    ...
    <>
      ...
      {!isOpen && (
        <Button
          ...
          className="fixed bottom-20 left-4 z-[99999] h-10 w-10 rounded-full bg-gray-800 hover:bg-gray-700 shadow-lg hover-scale group hover:shadow-[0_0_20px_rgba(156,163,175,0.5)]"
          size="icon"
