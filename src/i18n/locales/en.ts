...
const en: TranslationMap = {
  ...
  homeComponents: {
    ...
    // CapitalSafetyStrip
    investorProtection: 'Investor Protection',
    yourCapitalProtected: 'Your Capital, Always Protected',
    everyTransactionEscrow: 'Every transaction flows through our secure escrow infrastructure',
    fundWalletSecurely: 'Fund Wallet Securely',
    fundWalletSecurelyDesc: 'Deposit via bank transfer, e-wallet, or international payment',
    reserveViaEscrow: 'Reserve via Escrow',
    reserveViaEscrowDesc: 'Funds held in protected escrow until conditions are met',
    completeVerifiedTransaction: 'Complete Verified Transaction',
    completeVerifiedTransactionDesc: 'Property verified, legal checks passed, ownership transferred',
    fundsProtectedUntilDeal: 'Your funds remain protected until deal conditions are met.',
    ...
    alerts: 'Alerts',
    // LiveActivityTicker
    liveAnalyzed: 'LIVE — {count} properties analyzed by AI',
    newListingsToday: '{count} new listings today',
    coveringCities: 'Covering {count} cities across Indonesia',
    searchesThisWeek: '{count} searches this week',
    aiDealScoreActive: 'AI Deal Score active — ranking best opportunities',
    investorsExploring: 'Investors exploring properties now',
    newPropertyIn: 'New {type} in {city} — just added',
    live: 'Live',
    // NewsletterBanner
    ...
    earlyInvestmentOpportunities: 'Early Investment Opportunities',
    newBadge: 'New',
    preLaunchPrices: 'Get pre-launch prices on {count} off-plan projects with avg. {roi}% projected ROI.',
    exploreProjects: 'Explore Projects',
    // FirstFundingCTA
    ...
    popular: 'Popular',
    activeInvestorsPlus: '{count}+ active investors',
    avgYieldPercent: '{value}% avg. yield',
    ...
    dealFinder: 'Deal Finder',
    dealFinderDesc: 'AI undervalued properties',
    roiCalculator: 'ROI Calculator',
    roiCalculatorDesc: 'Projection modeling',
    mapExplorer: 'Map Explorer',
    mapExplorerDesc: 'Geospatial intelligence',
    servicesLabel: 'Services',
    servicesDesc: 'Renovation & legal',
    newProjectsLabel: 'New Projects',
    newProjectsDesc: 'Pre-launch inventory',
    portfolio: 'Portfolio',
    portfolioDesc: 'Track holdings',
    marketData: 'Market Data',
    marketDataDesc: 'Price indices',
    verification: 'Verification',
    verificationDesc: 'Blockchain docs',
