...
const en: TranslationMap = {
  ...
  shell: {
    ...
    trust: {
      ...
      verifiedSub: '100% Verified',
      secure: 'Secure Transactions',
      secureSub: 'Bank-Level Security',
      expert: 'Expert Support',
      expertSub: '24/7 Assistance',
    },
    footer: {
      tagline: 'The AI-powered Real Estate Operating System for premium property discovery, investment and management.',
  ...
  about: {
    ...
    subtitle: "Southeast Asia's AI-Powered Real Estate Operating System — Redefining luxury property investment and management through AI, fractionalization, and end-to-end ecosystem integration.",
    vision: 'Our Vision',
    visionText: 'To become Southeast Asia\'s leading AI-powered property and investment ecosystem connecting global investors, property owners, and developers in one integrated platform.',
    visionTag1: 'International Investor Support',
    visionTag2: 'Transparent Systems',
    visionTag3: 'Smart Real Estate Tech',
    visionTag4: 'Simplify Property Investment',
    visionTag5: 'Secure Ecosystem',
    visionTag6: 'Overseas Worker (PMI) Support',
    visionTag7: 'Connect Vendors, Agents & Clients',
    ecosystemTitle: 'Astra Villa Ecosystem Pillars',
    ecosystemMarketplace: 'Luxury Villa Marketplace',
    ecosystemMarketplaceDesc: 'AI-powered property recommendations, interactive maps, 3D virtual tours, smart filtering, and real-time ROI analysis tools.',
    ecosystemInvestment: 'Investment & Fractionalization',
    ecosystemInvestmentDesc: 'Tokenized property investment, fractional property ownership, smart investment rewards, and blockchain transaction records.',
    ecosystemAI: 'AI-Powered Intelligence',
    ecosystemAIDesc: 'Automated property recommendations, predictive market analysis, AI property valuation systems, and automated lead generation.',
    ecosystemManagement: 'Property Management',
    ecosystemManagementDesc: 'Real-time revenue tracking, automated maintenance dispatching, rental management, and smart property analytics.',
    ecosystemLegal: 'Legal & Compliance',
    ecosystemLegalDesc: 'PMA company setup guidance, legal documentation assistance, tax & compliance support, and investment risk analysis.',
    ecosystemVendor: 'Vendor & Service Marketplace',
    ecosystemVendorDesc: 'Verified vendor profiles, ratings & reviews, quotation systems, and online booking for all property service needs.',
    investmentSupportTitle: 'A-Z Property Investment Support',
    stepConsultation: 'Consultation',
    stepConsultationDesc: 'Investment planning, budget analysis, location selection, and ROI estimation.',
    stepLegal: 'Legal Structure',
    stepLegalDesc: 'PMA setup support, licensing guidance, banking support, and compliance verification.',
    stepSelection: 'Property Selection',
    stepSelectionDesc: 'Verified property listings, market analysis, 3D virtual viewing, and property inspections.',
    stepExecution: 'Investment Execution',
    stepExecutionDesc: 'Purchase handling, contract assistance, payment management, and ownership documentation.',
    stepManagement: 'Asset Management',
    stepManagementDesc: 'Rental management, maintenance services, revenue tracking, and property marketing.',
    techTitle: 'Smart Property Technology Platform',
    techFrontEnd: 'Front-End User Experience',
    techFrontEndDesc: 'Responsive mobile-first UI, luxury dark/light interface modes, smart user dashboards, 3D visualization systems, and real-time notifications.',
    techAI: 'AI Core & Processing',
    techAIDesc: 'AI property recommendations, automated lead generation, smart pricing systems, predictive market analysis, cloud database systems, and CRM integration.',
    techFuture: 'Future Infrastructure',
    techFutureDesc: 'Blockchain property systems, VR property tours, digital ownership verification, smart city integration, and AI investment advisors.',
    roadmapTitle: 'Technology Roadmap',
    roadmapPhase1: 'Phase 1: Current Architecture',
    roadmapCurrent: 'Active',
    roadmap1a: 'AI property recommendations',
    roadmap1b: 'Mobile-first platforms',
    roadmap1c: 'Cloud database systems',
    roadmap1d: 'Real-time analytics',
    roadmapPhase2: 'Phase 2: Immersive Tech',
    roadmapNext: 'Next',
    roadmap2a: 'VR property tours',
    roadmap2b: '3D visualization systems',
    roadmap2c: 'AI investment advisors',
    roadmap2d: 'Interactive property maps',
    roadmapPhase3: 'Phase 3: Web3 & Macro Integration',
    roadmapFuture: 'Future',
    roadmap3a: 'Blockchain property systems',
    roadmap3b: 'Digital ownership verification',
    roadmap3c: 'Smart city integration',
    roadmap3d: 'International property analytics',
    expansionTitle: 'Expansion Strategy Across Southeast Asia',
    expansionText: 'Scaling the highly secure, AI-powered digital investment ecosystem to redefine the future of property management and international investment accessibility across the Southeast Asia region.',
    values: 'Our Values',
    stats: 'Company Statistics',
    team: 'Our Team',
    teamText: 'Our dedicated team of real estate professionals brings years of experience and local market knowledge to help you make informed investment decisions within our AI-powered property ecosystem.',
    customerFirst: 'Customer First',
    customerFirstDesc: 'We prioritize our customers\' needs and satisfaction above all else in every aspect of the ecosystem.',
    trustTransparency: 'Trust & Transparency',
    trustTransparencyDesc: 'We maintain the highest standards of integrity in all our investment and property dealings.',
    excellence: 'Excellence',
    excellenceDesc: 'We strive for excellence in every service and technology we provide.',
    innovation: 'Innovation',
    innovationDesc: 'We embrace AI and blockchain technology to create better property investment experiences.',
    ...
    faqSubtitle: 'Everything you need to know about the Astra Villa REOS ecosystem.',
    faq1Q: 'What is Astra Villa REOS?',
    faq1A: 'Astra Villa REOS (Real Estate Operating System) is Southeast Asia\'s AI-powered platform that unifies a luxury villa marketplace, fractional investment, property management, legal & compliance, and a vendor marketplace into a single end-to-end ecosystem.',
    ...
    faq5Q: 'How are payments, escrow, and earnings secured?',
    faq5A: 'Payments flow through a fintech-grade escrow with a 9-state lifecycle, AI risk scoring, and verified webhooks from Midtrans and PayPal. Earnings are settled into your IDR wallet with full transaction history.',
    faq6Q: 'Which devices and languages are supported?',
    faq6A: 'The platform is fully responsive across desktop, tablet, and mobile, with pull-to-refresh, light/dark luxury themes, and complete Bahasa Indonesia and English support.',
  },
  ...
  indexPage: {
    ...
    forSale: 'For Sale',
    forRent: 'For Rent',
    aiSmartCollections: 'AI Smart Collections',
    aiPowered: 'AI Powered',
    bestInvestment: 'Best Investment',
    bestLiving: 'Best Living',
    luxury: 'Luxury',
    trending: 'Trending',
    noCollections: 'No properties scored yet. Collections update automatically as engagement grows.',
    trendingSearches: 'Trending Searches',
    popularLast7Days: 'Popular in the last 7 days',
    live: 'Live',
    searches: 'searches',
    aiRecommended: 'AI Recommended',
    aiPicksForYou: '✨ AI Picks for You',
    matchedToPrefs: 'properties matched to your preferences',
    trendingProperties: '✨ Trending Properties',
    showingPopular: 'Showing popular properties',
    exploreMore: 'Explore more',
    discover: 'Discover',
    guide: 'Guide',
    checkPriceEstimate: 'Check Your Property Price Estimate',
    yourProperty: 'Your Property',
    priceEstimateDesc: 'Get a market price estimate based on real-time data, AI analysis, and comparable property comparisons in your area.',
    roiRentalYield: 'ROI & Rental Yield',
    investmentScore: 'Investment Score',
    marketComparables: 'Market Comparables',
    checkPriceNow: 'Check Price Now',
    freeNoLoginInstant: 'Free • No login • Instant results',
  ...
  hero: {
    subtitle: 'Global Property Investment Platform',
    investorValue: 'Secure, AI-scored property investments in Indonesia — protected by escrow, backed by market intelligence.',
    ...
    forAgentsOwners: 'For Agents & Owners',
    listManage: 'List & manage property listings',
    promoteNewLaunch: 'Promote New Launch Projects',
    reachBuyers: 'Reach serious buyers & investors',
    aiSmartPrice: 'AI Smart Price & Market Insights',
    realtimeDashboard: 'Real-time analytics dashboard',
    firstTimeIndonesia: 'First Time in Indonesia',
    enjoyVirtualTour: 'Enjoy Virtual Tour Property:',
    apartment: 'Apartment',
    brandedResidence: 'Branded Residence',
    newLaunchProject: 'New Launch Project',
    foreignInvestment: 'Foreign Investment Program',
    onePlatform: 'One Platform.',
    fullAccess: 'Full Access.',
    smartExperience: 'Smart Property Experience.',
    exploreInvestment: 'Explore Investment Opportunities',
    startSecure: 'Start Secure Investment',
    listProperty: 'List Property',
    trustFooter: 'Escrow-Protected Transactions • Verified Listings • AI-Powered Investment Scoring',
  },
  listingPage: {
    aiEnhanced: 'AI Enhanced',
    propertiesAvailable: 'properties available',
    searchPlaceholder: 'Search location, property name...',
    searching: 'Searching...',
    searchBtn: 'Search',
    ...
    adjustFilters: 'Try adjusting your search filters to find matching properties',
    resetFilters: 'Reset Filters',
    forRent: 'Rent',
    forSale: 'Sale',
    preLaunch: 'Pre-Launch',
    viewDetails: 'View Details',
    allDisplayed: 'All properties have been displayed',
    buyTitle: 'Buy Properties',
    buySubtitle: 'Browse properties available for sale - Houses, Apartments, Commercial & Land',
    rentTitle: 'Rent Properties',
    rentSubtitle: 'Find rental properties - Residential, Commercial & Short-term rentals',
    newProjectsTitle: 'New Projects',
    newProjectsSubtitle: 'Discover new development projects across Indonesia',
    preLaunchTitle: 'Pre-Launching',
    preLaunchSubtitle: 'Get early access to upcoming property developments',
  },
  ...
  homeComponents: {
    ...
    rentInstantly: 'Rent Instantly',
    listAsVendor: 'List as Vendor',
    // HeroLiveCounters
    activeListings: 'Active Listings',
    investors: 'Investors',
    avgYield: 'Avg Yield',
    dealsPerMonth: 'Deals / Month',
    // UrgencyTimerStrip
    todayDealsRefresh: "Today's AI deals refresh in",
    newUndervaluedDaily: 'New undervalued properties daily',
    refreshing: 'Refreshing...',
    // TrustFooterStrip
    yourProtection: 'Your protection, our standard',
    verifiedListings: 'Verified Listings',
    verifiedListingsDesc: 'All properties reviewed before publication',
    secureData: 'Secure Data',
    secureDataDesc: 'End-to-end encrypted inquiries',
    fairPricing: 'Fair Pricing',
    fairPricingDesc: 'AI-audited market valuations',
    licensedAgents: 'Licensed Agents',
    licensedAgentsDesc: 'KYC-verified professionals',
    legalCompliance: 'ASTRAVILLA operates in compliance with Indonesian property transaction regulations. All listing data is independently verified and AI-audited for accuracy.',
    // QuickActionsRow
    watchlist: 'Watchlist',
    portfolio: 'Portfolio',
    ...
    marketIntelligence: 'Market Intelligence',
    dataDrivenInsights: 'Data-Driven Property Insights',
    trackAreaTrends: 'Track area price trends, discover undervalued markets, and identify top luxury zones across Indonesia.',
    priceTrends: 'Price Trends',
    heatMaps: 'Heat Maps',
    topLuxury: 'Top Luxury',
    exploreMarketData: 'Explore Market Data',
    // ReferralInviteStrip
    inviteEarnRewards: 'Invite & Earn Rewards',
    joinExplorers: 'Join 10,000+ Property Explorers',
    shareReferral: 'Share your referral link and earn ASTRA tokens for every signup',
    getPersonalized: 'Get personalized AI recommendations and exclusive deal alerts',
    earnPerReferral: 'Earn per referral',
    inviteFriends: 'Invite Friends',
    getStarted: 'Get Started',
    // CapitalSafetyStrip
    investorProtection: 'Investor Protection',
    capitalAlwaysProtected: 'Your Capital, Always Protected',
    secureEscrowFlow: 'Every transaction flows through our secure escrow infrastructure',
    fundWalletSecurely: 'Fund Wallet Securely',
    fundWalletDesc: 'Deposit via bank transfer, e-wallet, or international payment',
    reserveViaEscrow: 'Reserve via Escrow',
    reserveViaEscrowDesc: 'Funds held in protected escrow until conditions are met',
    completeVerifiedTransaction: 'Complete Verified Transaction',
    completeVerifiedDesc: 'Property verified, legal checks passed, ownership transferred',
    fundsProtectedUntil: 'Your funds remain protected until deal conditions are met.',
    // EarlyInvestmentCTA
    earlyInvestmentOpportunities: 'Early Investment Opportunities',
    preLaunchPricesDesc: 'Get pre-launch prices on off-plan projects with projected ROI.',
    exploreProjects: 'Explore Projects',
    // FinalConversionZone
    startYourJourney: 'Start Your Journey',
    joinGlobalInvestors: 'Join Global Investors Building',
    propertyWealthIndonesia: 'Property Wealth in Indonesia',
    aiPoweredInfrastructure: 'AI-Powered Investment Scoring • Escrow-Protected Transactions • Institutional-Grade Infrastructure',
    exploreOpportunities: 'Explore Opportunities',
    createAccount: 'Create Account',
    fundWallet: 'Fund Wallet',
    listPropertyGlobally: 'List Property Globally',
    speakToAdvisor: 'Speak to Advisor',
    // TechnologyAuthorityStrip
    intelligenceLayer: 'Intelligence Layer',
    astraIntelligencePowering: 'ASTRA Intelligence Powering',
    futureRealEstateMarkets: 'Future Real Estate Markets',
    autonomousSystems: 'Autonomous systems processing millions of data points to deliver institutional-grade property intelligence',
    autonomousDealMatching: 'Autonomous Deal Matching',
    autonomousDealMatchingDesc: 'AI pairs investors with optimal opportunities in real-time',
    predictiveValuation: 'Predictive Property Valuation',
    predictiveValuationDesc: 'Machine learning models forecasting fair market value',
    globalDemandNetwork: 'Global Demand Neural Network',
    globalDemandNetworkDesc: 'Cross-market demand pattern recognition engine',
    behavioralBuyerIntel: 'Behavioral Buyer Intelligence',
    behavioralBuyerIntelDesc: 'Intent prediction from browsing and engagement signals',
    aiValuationEngine: 'AI Valuation Engine',
    globalDemandHeatmap: 'Global Demand Heatmap',
    smartContractReady: 'Smart Contract Ready',
    predictiveAnalytics: 'Predictive Analytics',
    marketIntelligenceAPI: 'Market Intelligence API',
    tokenizationPipeline: 'Tokenization Pipeline',
    neuralNetworkScoring: 'Neural Network Scoring',
    // InvestorIntelligencePanel
    roiIntelligenceByCity: 'ROI Intelligence by City',
    aiForecast12Months: 'AI Forecast — Next 12 months projection',
    signal: 'Signal',
    trustSignals: 'Trust Signals',
    institutionalGradeVerification: 'Institutional Grade Verification',
    aiScoredInvestmentQuality: 'AI-Scored Investment Quality',
    globalInvestorNetwork: 'Global Investor Network',
    startPortfolio: 'Start Portfolio',
    // MarketHeatHighlight
    marketHeat: 'Market Heat',
    trendingCitiesThisWeek: 'Trending cities this week',
    // TrendingROIDeals
    topROIDeals: 'Top ROI Deals',
    trendingProperties: 'Trending Properties',
    seeAll: 'See All',
    engagements: 'engagements',
    // InvestorCredibilityShowcase
    trustedSupplyNetwork: 'Trusted Supply Network',
    verifiedAgentsAcross: 'Verified agents and premium developers across Indonesia',
    ...
    trustedByThousands: 'Trusted by thousands of property seekers across Indonesia',
    // MobileFloatingCTA
    explore: 'Explore',
    list: 'List',
    // WelcomeBackStrip
    ...
    propertiesExplored: 'properties explored',
    saved: 'Saved',
    priceDrops: 'Price Drops',
    aiPicks: 'AI Picks',
    dashboard: 'Dashboard',
    ...
    live: 'Live',
    // NewsletterBanner
    marketIntelligenceReport: 'Market Intelligence Report',
    weeklyAIInsights: 'Weekly AI insights on price trends, undervalued areas, and emerging investment opportunities.',
    youreSubscribed: "You're subscribed!",
    alreadySubscribed: "You're already subscribed!",
    welcomeNextReport: "Welcome! You'll receive our next market report.",
    ...
    manyInvestorsBegin: 'Many investors begin with Rp 2–5 million to explore opportunities.',
    testInvestment: 'Test investment',
    mostPopular: 'Most popular',
    recommended: 'Recommended',
    popular: 'Popular',
    escrowProtected: 'Escrow protected',
    fundYourWallet: 'Fund Your Wallet',
    browseOpportunitiesFirst: 'Browse Opportunities First',
    // DealHunterHero
    aiDealHunter: 'AI Deal Hunter',
    active: 'Active',
    viewAllBtn: 'View All',
    signalLabel: 'Signal',
    ...
    aiDetectedHighGrowth: 'AI-detected high-growth areas across Indonesia',
    exploreFullMap: 'Explore Full Map',
    // VendorEcosystemHub
    economicEcosystem: 'Economic Ecosystem',
    vendorMarketplacePartners: 'Vendor Marketplace Partners',
    trustedProfessionals: 'Trusted professionals powering every property transaction',
    developersTitle: 'Developers',
    developersDesc: 'Premier property development partners',
    interiorStudios: 'Interior Studios',
    interiorStudiosDesc: 'Luxury staging & renovation specialists',
    smartHomeTech: 'Smart Home Tech',
    smartHomeTechDesc: 'IoT installation & automation experts',
    legalFinance: 'Legal & Finance',
    legalFinanceDesc: 'Notary, tax advisory & mortgage partners',
    projectsLabel: 'Projects',
    valueLabel: 'Value',
    joinMarketplaceAsVendor: 'Join Marketplace as Vendor',
    // RentalCashflowZone
    liveIncomeAssets: 'Live Income Assets Generating Cashflow Now',
    yieldOptimizedUnits: 'Yield-optimized units with passive income estimates',
    furnished: 'Furnished',
    occupancyAI: 'Occupancy AI',
    demandLabel: 'Demand',
    reserveViewing: 'Reserve Viewing',
    perMonth: '/mo',
    // ExitIntentPopup
    waitDontMissOut: "Wait — Don't Miss Out!",
    getAIPoweredRecommendations: 'Get AI-powered property recommendations and price alerts delivered to your inbox.',
    createFreeAccount: 'Create Free Account',
    browsePropertiesInstead: 'Browse Properties Instead',
    freeForever: 'Free forever • No credit card required',
    // OpportunityStreakCards
    hotStreakUndervalued: 'Hot Streak — Undervalued Deals',
    refreshesIn: 'Refreshes in',
    aiPickLabel: 'AI Pick',
    // MarketplaceLiquidityStream
    marketplaceLiquidityFeed: 'Marketplace Liquidity Feed',
    // RecentlyViewedStrip
    ...
    platformOverviewLabel: 'Platform Overview',
    intelligentPropertyPlatform: "Indonesia's Intelligent Property",
    investmentPlatform: 'Investment Platform',
    platformDescription: 'AI-powered analytics, verified marketplace integrity, and premium investor tools — transforming how you discover and invest in Indonesian real estate.',
    aiIntelligenceEngine: 'AI Intelligence Engine',
    machineLearningPowered: 'Machine Learning Powered',
    aiIntelligenceDesc: 'Opportunity scoring, price predictions & personalized recommendations.',
    aiAccuracy: 'AI Accuracy',
    realTimeAnalytics: 'Real-Time Analytics',
    marketIntelligenceTitle: 'Market Intelligence',
    marketIntelligenceDesc: 'Live price trends, heat maps, and demand analytics across 34 provinces.',
    provincesCount: 'Provinces',
    verifiedMarketplace: 'Verified Marketplace',
    trustTransparency: 'Trust & Transparency',
    verifiedMarketplaceDesc: 'Every listing verified, every agent validated. Blockchain-backed integrity.',
    listingsCount: 'Listings',
    investorClub: 'Investor Club',
    exclusiveAccess: 'Exclusive Access',
    investorClubDesc: 'Tiered membership with early access, off-market deals & concierge.',
    tiersCount: 'Tiers',
    ecosystemTools: 'Ecosystem Tools',
    dealFinderTool: 'Deal Finder',
    dealFinderToolDesc: 'AI undervalued properties',
    roiCalculatorTool: 'ROI Calculator',
    roiCalculatorToolDesc: 'Projection modeling',
    mapExplorerTool: 'Map Explorer',
    mapExplorerToolDesc: 'Geospatial intelligence',
    servicesTool: 'Services',
    servicesToolDesc: 'Renovation & legal',
    newProjectsTool: 'New Projects',
    newProjectsToolDesc: 'Pre-launch inventory',
    portfolioTool: 'Portfolio',
    portfolioToolDesc: 'Track holdings',
    marketDataTool: 'Market Data',
    marketDataToolDesc: 'Price indices',
    verificationTool: 'Verification',
    verificationToolDesc: 'Blockchain docs',
    citiesCoveredStat: 'Cities Covered',
    aiModelsActive: 'AI Models Active',
    verifiedAgentsStat: 'Verified Agents',
  ...
  preQualification: {
    ...
    subtitle: 'Check your eligibility and download a pre-qualification summary in minutes',
  },
  // Escrow system
  escrow: {
    protection: 'Escrow Protection',
    secure: 'Secure',
    secureDeposit: 'Secure Escrow Deposit',
    secureDepositDesc: 'Your funds are held in a regulated escrow account',
    propertyVerification: 'Property Verification',
    propertyVerificationDesc: 'Legal documents and ownership verified by our team',
    completionTransfer: 'Completion & Transfer',
    completionTransferDesc: 'Funds released only when all conditions are satisfied',
    fundsProtectedNote: 'Your funds remain protected until legal verification and agreement conditions are completed. Full refund available if conditions are not met.',
    secureViaEscrow: 'Secure via Escrow',
    securePropertyViaEscrow: 'Secure Property via Escrow',
    match: 'match',
    reservationDeposit: 'Reservation Deposit',
    walletBalance: 'Wallet Balance',
    fundWallet: 'Fund Wallet',
    depositProtected: 'Escrow allows you to reserve the property while completing due diligence. Your deposit is fully protected.',
    fundsProtectedUntil: 'Funds remain protected until transaction conditions are satisfied. Full refund if verification fails.',
    // Payment flow
    escrowPayment: 'Escrow Payment',
    step: 'Step',
    confirmTerms: 'Confirm Terms',
    chooseDeposit: 'Choose Deposit',
    confirmTransaction: 'Confirm Transaction',
    propertyPrice: 'Property Price',
    fundsHeldSecure: 'Funds held in secure escrow until verification complete',
    fullRefundIfFails: 'Full refund if property fails verification',
    disputeResolution: 'Dispute resolution support included',
    deposit1Pct: '1% Deposit',
    deposit2Pct: '2% Deposit',
    deposit5Pct: '5% Deposit',
    transactionSummary: 'Transaction Summary',
    property: 'Property',
    escrowDeposit: 'Escrow Deposit',
    remainingBalance: 'Remaining Balance',
    confirmEscrowTerms: 'By confirming, you agree to the escrow terms. Funds are protected until conditions are met.',
    back: 'Back',
    cancel: 'Cancel',
    next: 'Next',
    confirmEscrow: 'Confirm Escrow',
    // Safety module
    howInvestmentSecured: 'How your investment is secured',
    reserveViaEscrow: 'Reserve via Escrow',
    reserveViaEscrowDesc: 'Funds held securely until conditions met',
    legalPropertyVerification: 'Legal & Property Verification',
    legalPropertyVerificationDesc: 'Ownership & permits validated by our team',
    secureCompletion: 'Secure Completion',
    secureCompletionDesc: 'Funds released only upon full verification',
    fundsRemainProtected: 'Funds remain protected',
    untilConditionsSatisfied: 'until transaction conditions are satisfied.',
  },
  // Trust & verification
  trust: {
    verifiedOwnership: 'Verified Ownership',
    verifiedOwnershipDesc: 'Property ownership documents verified by our legal team',
    developerCertified: 'Developer Certified',
    developerCertifiedDesc: 'Property developed by a certified and registered developer',
    legalChecked: 'Legal Checked',
    legalCheckedDesc: 'Legal documents (SHM/HGB, IMB, permits) reviewed and cleared',
    premiumPartner: 'Premium Partner',
    premiumPartnerDesc: 'Listed by an exclusive Premium Partner with top trust rating',
    ownershipVerified: 'Ownership Verified',
    ownershipVerifiedAdmin: 'Admin-verified ownership',
    governmentApproved: 'Government Approved',
    governmentApprovedDesc: 'Government permits verified',
    bankPartner: 'Bank Partner',
    bankPartnerDesc: 'Eligible for partner bank mortgages',
    premiumListing: 'Premium Listing',
    premiumListingDesc: 'Enhanced premium listing',
    ecoCertified: 'Eco Certified',
    ecoCertifiedDesc: 'Meets sustainability standards',
    verifiedOwner: 'Verified Owner',
    verifiedOwnerDesc: 'Owner identity verified',
    verifiedAgent: 'Verified Agent',
    verifiedAgentDesc: 'Licensed agent with verified credentials',
    verifiedAgency: 'Verified Agency',
    verifiedAgencyDesc: 'Registered agency with verified profile',
  },
  // Wallet & funding
  wallet: {
    readyToInvest: 'Ready to Invest?',
    fundWalletToReserve: 'Fund your wallet to reserve this property',
    reservationDeposit: 'reservation deposit',
