  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        admin: {
          bg: 'hsl(var(--admin-bg-main, 222 50% 5%))',
          sidebar: 'hsl(var(--admin-bg-sidebar, 220 42% 9%))',
          card: 'hsl(var(--admin-bg-card, 218 40% 11%))',
          hover: 'hsl(var(--admin-bg-hover, 218 35% 13%))',
          'border-subtle': 'hsl(var(--admin-border-subtle, 216 25% 17%))',
          'border-strong': 'hsl(var(--admin-border-strong, 214 22% 24%))',
          'accent-ai': 'hsl(var(--admin-accent-ai, 160 100% 44%))',
          'accent-warning': 'hsl(var(--admin-accent-warning, 36 100% 56%))',
          'accent-danger': 'hsl(var(--admin-accent-danger, 352 100% 67%))',
          'accent-info': 'hsl(var(--admin-accent-info, 213 100% 65%))',
        },
      },
      borderRadius: {
        lg: "var(--radius)",
