  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // Professional iOS/macOS Color System
        'ios': {
          'blue': '#007AFF',
          'blue-light': '#4A90E2',
          'blue-dark': '#0056CC',
      ...
      backgroundImage: {
        'professional-gradient': 'linear-gradient(135deg, #007AFF 0%, #4A90E2 100%)',
        'professional-dark-gradient': 'linear-gradient(180deg, #111827 0%, #1F2937 100%)',
        'professional-card-gradient': 'linear-gradient(135deg, #F3F4F6 0%, rgba(0, 122, 255, 0.05) 100%)',
      },
      boxShadow: {
        'professional': '0 8px 32px rgba(0, 0, 0, 0.1)',
        'professional-hover': '0 20px 60px rgba(0, 122, 255, 0.25)',
        'professional-glow': '0 0 20px rgba(0, 122, 255, 0.3)',
      }
    },
  },
