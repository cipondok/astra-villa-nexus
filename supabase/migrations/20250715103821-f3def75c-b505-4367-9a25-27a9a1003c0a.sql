-- Add required columns to vendor_main_categories if they don't exist
ALTER TABLE public.vendor_main_categories 
ADD COLUMN IF NOT EXISTS slug text,
ADD COLUMN IF NOT EXISTS description text,
ADD COLUMN IF NOT EXISTS icon text;

-- First, clear any approved service names that reference subcategories
DELETE FROM public.approved_service_names WHERE sub_category_id IS NOT NULL;

-- Clear existing data safely
DELETE FROM public.vendor_subcategories;
DELETE FROM public.vendor_main_categories;

-- Insert main categories for Products and Services
...
-- Insert subcategories for Electrical & Electronics (Product)
...
-- Insert subcategories for Furniture & Household Items (Product)
INSERT INTO public.vendor_subcategories (name, description, icon, main_category_id, display_order, is_active) 
...
-- Insert subcategories for Building Materials (Product)
INSERT INTO public.vendor_subcategories (name, description, icon, main_category_id, display_order, is_active) 
...
-- Insert subcategories for Repair & Maintenance (Service)
INSERT INTO public.vendor_subcategories (name, description, icon, main_category_id, display_order, is_active) 
...
-- Insert subcategories for Construction & Design (Service)
INSERT INTO public.vendor_subcategories (name, description, icon, main_category_id, display_order, is_active) 
...
-- Insert subcategories for Property & Administrative (Service)
INSERT INTO public.vendor_subcategories (name, description, icon, main_category_id, display_order, is_active) 
