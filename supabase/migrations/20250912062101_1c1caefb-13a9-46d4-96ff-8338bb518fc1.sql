-- Insert sample vendor business profiles and services for testing
-- First, let's create some sample vendor profiles
...
-- Now insert sample services using the existing category
...
WHERE vbp.business_name IN ('CleanPro Services', 'GreenThumb Landscaping', 'FixIt Repair Services');