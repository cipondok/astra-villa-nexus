-- Comprehensive Indonesian Administrative Location Data Migration
-- This migration populates the locations table with official Indonesian administrative divisions
-- Based on BPS (Badan Pusat Statistik) 2024 data: 38 provinces, 98 cities, 416 regencies

-- First, let's clean up any inconsistent data and ensure proper structure
UPDATE locations SET province_name = TRIM(province_name), city_name = TRIM(city_name) WHERE province_name != TRIM(province_name) OR city_name != TRIM(city_name);

-- Insert/Update all 38 Indonesian Provinces with major cities and regencies
-- SUMATERA REGION
INSERT INTO locations (province_code, province_name, city_code, city_name, city_type, district_code, district_name, area_name, is_active, is_capital) VALUES
...
('11', 'Aceh', '1104', 'Aceh Tengah', 'KABUPATEN', '110401', 'Lut Tawar', 'Aceh Tengah', true, false),
...
('12', 'Sumatera Utara', '1202', 'Tapanuli Tengah', 'KABUPATEN', '120201', 'Pandan', 'Tapanuli Tengah', true, false),
...
('13', 'Sumatera Barat', '1302', 'Solok', 'KABUPATEN', '130201', 'Arosuka', 'Solok', true, false),
...
('14', 'Riau', '1402', 'Indragiri Hulu', 'KABUPATEN', '140201', 'Rengat', 'Indragiri Hulu', true, false),
...
('15', 'Jambi', '1502', 'Merangin', 'KABUPATEN', '150201', 'Bangko', 'Merangin', true, false),
...
('16', 'Sumatera Selatan', '1601', 'Ogan Komering Ulu', 'KABUPATEN', '160101', 'Baturaja Barat', 'Ogan Komering Ulu', true, false),
...
('17', 'Bengkulu', '1702', 'Rejang Lebong', 'KABUPATEN', '170201', 'Curup', 'Rejang Lebong', true, false),
...
('18', 'Lampung', '1802', 'Tanggamus', 'KABUPATEN', '180201', 'Kota Agung', 'Tanggamus', true, false),
...
('19', 'Kepulauan Bangka Belitung', '1902', 'Belitung', 'KABUPATEN', '190201', 'Tanjung Pandan', 'Belitung', true, false),
...
('21', 'Kepulauan Riau', '2101', 'Karimun', 'KABUPATEN', '210101', 'Karimun', 'Karimun', true, false),
('21', 'Kepulauan Riau', '2102', 'Bintan', 'KABUPATEN', '210201', 'Bintan Timur', 'Bintan', true, false),
...
('31', 'DKI Jakarta', '3101', 'Kepulauan Seribu', 'KABUPATEN', '310101', 'Kepulauan Seribu Selatan', 'Kepulauan Seribu', true, false),
...
('32', 'Jawa Barat', '3273', 'Bandung', 'KOTA', '327301', 'Bandung Kulon', 'Bandung', true, false),
...
('32', 'Jawa Barat', '3277', 'Cimahi', 'KOTA', '327701', 'Cimahi Selatan', 'Cimahi', true, false),
('32', 'Jawa Barat', '3278', 'Tasikmalaya', 'KOTA', '327801', 'Kawalu', 'Tasikmalaya', true, false),
('32', 'Jawa Barat', '3279', 'Banjar', 'KOTA', '327901', 'Banjar', 'Banjar', true, false),
('32', 'Jawa Barat', '3201', 'Bogor', 'KABUPATEN', '320101', 'Nanggung', 'Bogor', true, false),
('32', 'Jawa Barat', '3202', 'Sukabumi', 'KABUPATEN', '320201', 'Palabuhanratu', 'Sukabumi', true, false),
...
('33', 'Jawa Tengah', '3373', 'Salatiga', 'KOTA', '337301', 'Sidorejo', 'Salatiga', true, false),
...
('33', 'Jawa Tengah', '3376', 'Tegal', 'KOTA', '337601', 'Tegal Selatan', 'Tegal', true, false),
('33', 'Jawa Tengah', '3301', 'Cilacap', 'KABUPATEN', '330101', 'Cilacap Selatan', 'Cilacap', true, false),
...
('34', 'DI Yogyakarta', '3403', 'Gunung Kidul', 'KABUPATEN', '340301', 'Wonosari', 'Gunung Kidul', true, false),
('34', 'DI Yogyakarta', '3404', 'Sleman', 'KABUPATEN', '340401', 'Moyudan', 'Sleman', true, false),

-- 15. JAWA TIMUR (35)
('35', 'Jawa Timur', '3571', 'Kediri', 'KOTA', '357101', 'Mojoroto', 'Kediri', true, false),
('35', 'Jawa Timur', '3572', 'Blitar', 'KOTA', '357201', 'Kepanjenkidul', 'Blitar', true, false),
('35', 'Jawa Timur', '3573', 'Malang', 'KOTA', '357301', 'Klojen', 'Malang', true, false),
('35', 'Jawa Timur', '3574', 'Probolinggo', 'KOTA', '357401', 'Kademangan', 'Probolinggo', true, false),
('35', 'Jawa Timur', '3575', 'Pasuruan', 'KOTA', '357501', 'Gadingrejo', 'Pasuruan', true, false),
('35', 'Jawa Timur', '3576', 'Mojokerto', 'KOTA', '357601', 'Prajurit Kulon', 'Mojokerto', true, false),
('35', 'Jawa Timur', '3577', 'Madiun', 'KOTA', '357701', 'Taman', 'Madiun', true, false),
...
('35', 'Jawa Timur', '3501', 'Pacitan', 'KABUPATEN', '350101', 'Pacitan', 'Pacitan', true, false),
...
('36', 'Banten', '3601', 'Pandeglang', 'KABUPATEN', '360101', 'Pandeglang', 'Pandeglang', true, false),
('36', 'Banten', '3602', 'Lebak', 'KABUPATEN', '360201', 'Rangkasbitung', 'Lebak', true, false),
...
('51', 'Bali', '5103', 'Badung', 'KABUPATEN', '510301', 'Mengwi', 'Badung', true, false),
('51', 'Bali', '5104', 'Gianyar', 'KABUPATEN', '510401', 'Gianyar', 'Gianyar', true, false),
...
('52', 'Nusa Tenggara Barat', '5201', 'Lombok Barat', 'KABUPATEN', '520101', 'Gerung', 'Lombok Barat', true, false),
('52', 'Nusa Tenggara Barat', '5202', 'Lombok Tengah', 'KABUPATEN', '520201', 'Praya', 'Lombok Tengah', true, false),
...
('53', 'Nusa Tenggara Timur', '5302', 'Sumba Timur', 'KABUPATEN', '530201', 'Waingapu', 'Sumba Timur', true, false),

-- Continue with remaining provinces...
-- KALIMANTAN REGION (20-24)
...
('61', 'Kalimantan Barat', '6101', 'Sambas', 'KABUPATEN', '610101', 'Sambas', 'Sambas', true, false),

-- 21. KALIMANTAN TENGAH (62)
('62', 'Kalimantan Tengah', '6271', 'Palangka Raya', 'KOTA', '627101', 'Pahandut', 'Palangka Raya', true, true),
('62', 'Kalimantan Tengah', '6201', 'Kotawaringin Barat', 'KABUPATEN', '620101', 'Pangkalan Bun', 'Kotawaringin Barat', true, false),
...
('63', 'Kalimantan Selatan', '6301', 'Tanah Laut', 'KABUPATEN', '630101', 'Pelaihari', 'Tanah Laut', true, false),
...
('64', 'Kalimantan Timur', '6474', 'Bontang', 'KOTA', '647401', 'Bontang Selatan', 'Bontang', true, false),
('64', 'Kalimantan Timur', '6401', 'Paser', 'KABUPATEN', '640101', 'Tanah Grogot', 'Paser', true, false),
...
('71', 'Sulawesi Utara', '7173', 'Tomohon', 'KOTA', '717301', 'Tomohon Selatan', 'Tomohon', true, false),
('71', 'Sulawesi Utara', '7174', 'Kotamobagu', 'KOTA', '717401', 'Kotamobagu Barat', 'Kotamobagu', true, false),
('71', 'Sulawesi Utara', '7101', 'Minahasa', 'KABUPATEN', '710101', 'Tondano', 'Minahasa', true, false),

-- 26. SULAWESI TENGAH (72)
('72', 'Sulawesi Tengah', '7271', 'Palu', 'KOTA', '727101', 'Palu Barat', 'Palu', true, true),
('72', 'Sulawesi Tengah', '7201', 'Banggai Kepulauan', 'KABUPATEN', '720101', 'Salakan', 'Banggai Kepulauan', true, false),
...
('73', 'Sulawesi Selatan', '7373', 'Palopo', 'KOTA', '737301', 'Wara', 'Palopo', true, false),
('73', 'Sulawesi Selatan', '7301', 'Selayar', 'KABUPATEN', '730101', 'Benteng', 'Selayar', true, false),
...
('74', 'Sulawesi Tenggara', '7401', 'Buton', 'KABUPATEN', '740101', 'Pasarwajo', 'Buton', true, false),

-- 29. GORONTALO (75)
('75', 'Gorontalo', '7571', 'Gorontalo', 'KOTA', '757101', 'Kota Selatan', 'Gorontalo', true, true),
('75', 'Gorontalo', '7501', 'Boalemo', 'KABUPATEN', '750101', 'Tilamuta', 'Boalemo', true, false),

-- 30. SULAWESI BARAT (76)
('76', 'Sulawesi Barat', '7601', 'Majene', 'KABUPATEN', '760101', 'Banggae', 'Majene', true, true),
('76', 'Sulawesi Barat', '7602', 'Polewali Mandar', 'KABUPATEN', '760201', 'Polewali', 'Polewali Mandar', true, false),

-- MALUKU REGION (31-32)
-- 31. MALUKU (81)
('81', 'Maluku', '8171', 'Ambon', 'KOTA', '817101', 'Sirimau', 'Ambon', true, true),
('81', 'Maluku', '8172', 'Tual', 'KOTA', '817201', 'Dullah Selatan', 'Tual', true, false),
('81', 'Maluku', '8101', 'Maluku Tenggara Barat', 'KABUPATEN', '810101', 'Saumlaki', 'Maluku Tenggara Barat', true, false),
...
('82', 'Maluku Utara', '8201', 'Halmahera Barat', 'KABUPATEN', '820101', 'Jailolo', 'Halmahera Barat', true, false),

-- PAPUA REGION (33-38)
-- 33. PAPUA BARAT (91)
('91', 'Papua Barat', '9171', 'Sorong', 'KOTA', '917101', 'Sorong Barat', 'Sorong', true, false),
('91', 'Papua Barat', '9101', 'Fakfak', 'KABUPATEN', '910101', 'Fakfak', 'Fakfak', true, false),
('91', 'Papua Barat', '9102', 'Kaimana', 'KABUPATEN', '910201', 'Kaimana', 'Kaimana', true, false),
('91', 'Papua Barat', '9103', 'Teluk Wondama', 'KABUPATEN', '910301', 'Rasiei', 'Teluk Wondama', true, false),
('91', 'Papua Barat', '9104', 'Teluk Bintuni', 'KABUPATEN', '910401', 'Bintuni', 'Teluk Bintuni', true, false),
...
('94', 'Papua', '9402', 'Jayawijaya', 'KABUPATEN', '940201', 'Wamena', 'Jayawijaya', true, false),
('94', 'Papua', '9403', 'Nabire', 'KABUPATEN', '940301', 'Nabire', 'Nabire', true, false),
('94', 'Papua', '9408', 'Kepulauan Yapen', 'KABUPATEN', '940801', 'Serui', 'Kepulauan Yapen', true, false),

-- NEW PAPUA PROVINCES (35-38) - Recently established
-- 35. PAPUA TENGAH (92)
('92', 'Papua Tengah', '9201', 'Mimika', 'KABUPATEN', '920101', 'Timika', 'Mimika', true, true),
('92', 'Papua Tengah', '9202', 'Puncak Jaya', 'KABUPATEN', '920201', 'Mulia', 'Puncak Jaya', true, false),

-- 36. PAPUA PEGUNUNGAN (93)
('93', 'Papua Pegunungan', '9301', 'Jayawijaya', 'KABUPATEN', '930101', 'Wamena', 'Jayawijaya', true, true),
('93', 'Papua Pegunungan', '9302', 'Lanny Jaya', 'KABUPATEN', '930201', 'Tiom', 'Lanny Jaya', true, false),

-- 37. PAPUA SELATAN (95)
('95', 'Papua Selatan', '9501', 'Merauke', 'KABUPATEN', '950101', 'Merauke', 'Merauke', true, true),
('95', 'Papua Selatan', '9502', 'Boven Digoel', 'KABUPATEN', '950201', 'Tanah Merah', 'Boven Digoel', true, false),

-- 38. PAPUA BARAT DAYA (96)
('96', 'Papua Barat Daya', '9601', 'Sorong', 'KABUPATEN', '960101', 'Aimas', 'Sorong', true, false),
('96', 'Papua Barat Daya', '9602', 'Sorong Selatan', 'KABUPATEN', '960201', 'Teminabuan', 'Sorong Selatan', true, true)

ON CONFLICT (province_code, city_code, district_code) 
DO UPDATE SET 
...
-- Update location statistics and metadata
UPDATE locations SET updated_at = now() WHERE updated_at < now() - INTERVAL '1 hour';
