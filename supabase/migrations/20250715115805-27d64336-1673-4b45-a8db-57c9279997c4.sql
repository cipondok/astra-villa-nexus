...
INSERT INTO public.vendor_sub_categories (id, name, slug, description, icon, main_category_id, display_order, is_active) VALUES
  ...
  ('fa1', 'Mens Clothing', 'mens-clothing', 'Mens apparel and clothing', '👔', '6ba7b811-9dad-11d1-80b4-00c04fd430c8', 1, true),
  ('fa2', 'Womens Clothing', 'womens-clothing', 'Womens apparel and clothing', '👗', '6ba7b811-9dad-11d1-80b4-00c04fd430c8', 2, true),
