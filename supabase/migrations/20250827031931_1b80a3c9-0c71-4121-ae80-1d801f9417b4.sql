-- Secure Vendor Financial Information
...
-- Update the log_financial_access function to return a value for policy usage
...
-- Create an additional security table for financial access alerts
CREATE TABLE IF NOT EXISTS public.financial_access_alerts (
  id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  user_id uuid NOT NULL,
  access_type text NOT NULL,
  vendor_affected uuid,
...
-- Enable RLS on the financial access alerts table
ALTER TABLE public.financial_access_alerts ENABLE ROW LEVEL SECURITY;

-- Only financial admins can manage financial access alerts
CREATE POLICY "Financial admins manage access alerts"
ON public.financial_access_alerts
FOR ALL
USING (check_financial_admin_access())
WITH CHECK (check_financial_admin_access());