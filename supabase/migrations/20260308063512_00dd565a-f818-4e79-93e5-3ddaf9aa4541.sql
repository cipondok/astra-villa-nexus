...
SELECT cron.schedule(
  'daily-seo-auto-analysis',
  '0 3 * * *',
  $$
  SELECT net.http_post(
    url := 'https://zymrajuuyyfkzdmptebl.supabase.co/functions/v1/ai-engine',
    ...
    body := '{"mode": "seo_generate", "payload": {"action": "analyze-batch", "limit": 50, "filter": "unanalyzed"}}'::jsonb
  ) AS request_id;
  $$
);
